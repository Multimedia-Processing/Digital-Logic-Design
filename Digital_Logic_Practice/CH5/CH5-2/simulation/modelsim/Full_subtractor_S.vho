...
-- Do	=>  Location: PIN_AD10,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Bo	=>  Location: PIN_AF10,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Bi	=>  Location: PIN_AC28,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF Full_subtractor_S IS
...
SIGNAL \ALT_INV_Bi~input_o\ : std_logic;
...
\ALT_INV_Bi~input_o\ <= NOT \Bi~input_o\;
...
-- Equation(s):
-- \inst1|inst~combout\ = ( \B~input_o\ & ( \Bi~input_o\ & ( \A~input_o\ ) ) ) # ( !\B~input_o\ & ( \Bi~input_o\ & ( !\A~input_o\ ) ) ) # ( \B~input_o\ & ( !\Bi~input_o\ & ( !\A~input_o\ ) ) ) # ( !\B~input_o\ & ( !\Bi~input_o\ & ( \A~input_o\ ) ) )
...
PORT MAP (
	...
	dataf => \ALT_INV_Bi~input_o\,
	combout => \inst1|inst~combout\);

-- Location: LABCELL_X88_Y20_N9
inst2 : cyclonev_lcell_comb
-- Equation(s):
-- \inst2~combout\ = ( \B~input_o\ & ( \Bi~input_o\ ) ) # ( !\B~input_o\ & ( \Bi~input_o\ & ( !\A~input_o\ ) ) ) # ( \B~input_o\ & ( !\Bi~input_o\ & ( !\A~input_o\ ) ) )
