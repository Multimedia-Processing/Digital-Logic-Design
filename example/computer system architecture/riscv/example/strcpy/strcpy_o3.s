...
# -auxbase-strip strcpy/strcpy_o3.s -O3 -fverbose-asm
...
# strcpy/strcpy.c:5:     while ((x[i]=y[i]) != '\0')
	lbu	a5,0(a1)	# _15, *y_7(D)
# strcpy/strcpy.c:5:     while ((x[i]=y[i]) != '\0')
	sb	a5,0(a0)	# _15, *x_8(D)
# strcpy/strcpy.c:5:     while ((x[i]=y[i]) != '\0')
	beq	a5,zero,.L1	#, _15,,
	addi	a1,a1,1	#, ivtmp.7, y
	addi	a0,a0,1	#, ivtmp.9, x
.L3:
# strcpy/strcpy.c:5:     while ((x[i]=y[i]) != '\0')
	lbu	a5,0(a1)	# _3, MEM[base: _22, offset: 0B]
# strcpy/strcpy.c:5:     while ((x[i]=y[i]) != '\0')
	addi	a0,a0,1	#, ivtmp.9, ivtmp.9
	addi	a1,a1,1	#, ivtmp.7, ivtmp.7
# strcpy/strcpy.c:5:     while ((x[i]=y[i]) != '\0')
	sb	a5,-1(a0)	# _3, MEM[base: _23, offset: 0B]
# strcpy/strcpy.c:5:     while ((x[i]=y[i]) != '\0')
	bne	a5,zero,.L3	#, _3,,
.L1:
# strcpy/strcpy.c:7: }
