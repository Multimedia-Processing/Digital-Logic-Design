...
# -march=rv64imafdc -auxbase-strip leaf_example/leaf_example_o3.s -O3
# -fverbose-asm
...
# leaf_example/leaf_example.c:3:     f = (g+h)-(i+j);
	addw	a0,a0,a1	# tmp146, tmp142, tmp145
# leaf_example/leaf_example.c:3:     f = (g+h)-(i+j);
	addw	a2,a2,a3	# tmp148, tmp143, tmp147
# leaf_example/leaf_example.c:5: }
	subw	a0,a0,a2	#, tmp142, tmp143
	ret	
